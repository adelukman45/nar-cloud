...
@section('container')
    ...
    <form method="POST" action="/dashboard/clouds/{{ $cloud->id }}" class="mb-5">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control @error('storage') is-invalid @enderror" id="storage" name="storage"
                    required autofocus value="{{ old('storage', $cloud->storage) }}">
                @error('storage')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control @error('price') is-invalid @enderror" id="price" name="price"
                    required autofocus value="{{ old('price', $cloud->price) }}">
                @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
